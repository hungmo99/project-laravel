...
<!-- Mirrored from admin.pixelstrap.com/cuba/theme/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jan 2021 10:23:06 GMT -->
<head>
      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{asset('Admin/images/logo/logo.png')}}" alt=""></a></div>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown"><i data-feather="message-square"></i>
                <ul class="chat-dropdown onhover-show-div">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="{{asset('Admin/images/user/2.jpg')}}" alt="">
              ...
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="media profile-media"><img class="b-r-10" src="{{asset('Admin/images/dashboard/profile.jpg')}}" alt="">
