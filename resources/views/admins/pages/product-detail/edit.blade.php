                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4>Atrribute Product: {{$product->name}}</h4>
                                <h4>Code: {{$product->sku}}</h4>
                                <form action="{{route('product-detail.update',['id'=>$product->id,'id_detail'=>$product_detail->id])}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="form-group col">
                                            <label for="sku">SKU</label>
                                            <input type="text" class="form-control " placeholder="Sku" id="sku"name="sku" value="{{$product_detail->sku}}" readonly/>
                                            @error('sku')
                                        ...
                                        <div class="form-group  col">
                                            <label for="id_attr">Size</label><a href="{{route('attr.index')}}" class=""> --Thêm mới--</a>
